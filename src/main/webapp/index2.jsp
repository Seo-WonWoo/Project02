		...
		<div class="inner">
			...
			<form action="index2.jsp" method="post" id="surch_form">
				<div class="store_search_box mt20">
							...
							<div class="field">
								...
								<div class="td">
									<label style="display: none">시도</label> <select
										name="surch_city" id="city_select" size="1"
							...
							<div class="field">
								...
								<div class="td">
									<label style="display: none">구</label> <select
										name="surch_country" id="country_select" size="1"
							...
							<div class="field">
								...
								<div class="td">
									<label style="display: none">동/면</label> <select
										name="surch_dong" id="dong_select" size="1">
										<option value="" selected>전체</option>
									</select>
							...
							<div class="field">
								...
								<div class="td">
									<label style="display: none">업종</label> <select
										name="surch_restaurant_sector" size="1">
										<option value="" selected>전체</option>
										<%
							...
							<div class="field">
								...
								<div class="td">
									<label style="display: none">인증</label> <select
										name="surch_certification" size="1">
										<option value="" selected>전체</option>
										<%
						...
						<div class="field">
							...
							<div class="td">
								<div class="icheck_wrap">
									...
									<div class="icheck mar">
										<input type="checkbox"
											name='surch_convenience_<%=convenience.getConvenienceId()%>'
					...
					<div class="item">
						<div class="col3">
							<div class="field">
								...
								<div class="td">
									<input type="text" name="surch_restaurant_name" id="bsshNm"
										value="">
								</div>
							</div>
						</div>
					...
					<div class="btn2" onclick="surchSubmit()" style="float: right;">검색</div>
				</div>
			</form>
